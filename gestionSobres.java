...
public class gestionSobres {
    ...
    public static void abrirSobre() {
        ...
        if (estadoJugador.estadoJugador.get("sobres") < 1) {
            ...
            System.out.println(utilidades.cargarAsciiArt("file" + pokemon1.get("Imagen_ASCII")));
            ...
            System.out.println(utilidades.cargarAsciiArt("file" + pokemon2.get("Imagen_ASCII")));
            ...
            System.out.println(utilidades.cargarAsciiArt("file" + pokemon3.get("Imagen_ASCII")));
            ...
            System.out.println(utilidades.cargarAsciiArt("file" + pokemon4.get("Imagen_ASCII")));
            ...
            System.out.println(utilidades.cargarAsciiArt("file" + pokemon5.get("Imagen_ASCII")));
    ...
    public static HashMap<String, String> seleccionarCartaAleatoria() {
        ...
        ArrayList<HashMap<String, String>> pokemonsData = utilidades.cargarPokemonData("file");
